...
- `StageEngine` — the **only** writer of `package_stage.status`. Completion is computed (mandatory fields confirmed, validations pass; documents do not block), never simply set; a not-ready completion returns the list of reasons.
